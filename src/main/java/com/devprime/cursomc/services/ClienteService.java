...
public class ClienteService {
	...
	public void delete(Integer id) throws ObjectNotFoundException {
		...
		try {
			...
			throw new DataIntegrityViolationException("Nao foi possivel apagar o cliente, porque ha entidades relacionadas");
		}
	}
	...
	public Cliente fromDTO(ClienteNewDTO objDTO) {
		Cliente cli = new Cliente(null, objDTO.getNome(), objDTO.getEmail(), objDTO.getCodigoPostal(), TipoCliente.toEnum(objDTO.getTipoCliente()));
		Cidade cid = new Cidade(objDTO.getCidadeId(), null, null);
		Endereco ender = new Endereco(null, objDTO.getLogradouro(), objDTO.getNumero(), objDTO.getComplemento(), objDTO.getBairro(), objDTO.getCep(), cli, cid );
