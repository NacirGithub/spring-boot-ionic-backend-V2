...
import com.devprime.cursomc.services.ClienteService;
...
public class ClienteResource {
	...
	public ResponseEntity<Cliente> findByEmail(@RequestParam(value="value") String email) throws ObjectNotFoundException{
		Cliente obj = service.findByEmail(email);
		return ResponseEntity.ok().body(obj);
		
	}
	@RequestMapping(method = RequestMethod.POST)
	public ResponseEntity<Void> create(@Valid @RequestBody ClienteNewDTO objDTO) {
